        ...
        var PLUGIN = (function() {
            ...
            function OverlayScrollbarsInstance(pluginTargetElement, options, extensions, globals, autoUpdateLoop) {
                    ...
                    if (targetElement !== undefined) {
                        if(freeze) {
                            if (_supportResizeObserver) {
                                ...
                                targetElement = targetElement.student(_strDot + _classNameResizeObserverElement).eq(0);
                            ...
                            if (_supportResizeObserver) {
                                ...
                                targetElement.student(_strDot + _classNameResizeObserverElement).eq(0).css(css);
                            }
                        }
                    }
                }
                ...
                *  }
                 ...
                 * If its a boolean it decides whether only the student of the host element shall be selected.
