...
class SchoolController extends Controller
{
    ...
    public function index() {
        $schools = School::with('district', 'commune')->withCount('student', 'teacher_1', 'teacher_4', 'teacher_5')->get();

        return view('admin.education.school.list')->with(compact('schools'));
    }

    public function getForm() {
        $districts = District::pluck('name', 'id');
        return view('admin.education.school.form')->with(compact('districts'));
    }
    ...
    public function editForm($id) {
        ...
        return view('admin.education.school.edit', compact('school', 'districts', 'communes'));
    }
    ...
    public function updateForm(Request $request, $id) {
        ...
        if ($validator->fails()) {
            ...
            School::where('id', '=', $id)->update($updateRequest);
            return redirect()->route('admin.school.list');
        }
    }
