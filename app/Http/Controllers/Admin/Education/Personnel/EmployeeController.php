...
class EmployeeController extends Controller
{
    ...
    public function index() {
        $employees = Personnel::where('type_teacher', '=', 7)->with('school', 'commune', 'district')->get();
        $districts = District::pluck('name', 'id');
        return view('admin.education.personnel.employee.list')->with(compact('employees', 'districts'));
    }

    public function filter(Request $request) {
        $districts = District::pluck('name', 'id');
        $employees = Personnel::with('commune','district', 'school')->where('type_teacher', '=', 7);
        $filter = [];
        ...
        $employees = $employees->where($filter)->get();
        return view('admin.education.personnel.employee.list')->with(compact('employees', 'districts'));
    }
    ...
    public function getForm() {
        ...
        $districts = District::pluck('name', 'id');
        return view('admin.education.personnel.employee.form')->with(compact('schools','districts'));
    }
    ...
    public function saveForm(Request $request) {
        ...
        if ($validator->fails()) {
            ...
            return redirect()->route('admin.personnel.employee.list');
        }
    }
    ...
    public function editForm($id) {
        ...
        $districts = District::pluck('name', 'id');
        $communes = Commune::where('district_id', '=', $employee->district_id)->pluck('name', 'id');
        $schools = School::where('type_school', '=', $employee->type_school)->pluck('name', 'id');
        return view('admin.education.personnel.employee.edit', compact('employee', 'schools', 'districts', 'communes'));
    }
...
//        field => title
        ...
        $teachers = Personnel::where('type_teacher', '=', 7)->with('district', 'commune', 'school')->orderBy('created_at', 'desc')->get();
        ...
        $this->downloadExcel('Nhân viên data'.date('Y-m-d'), $exportFields, $data, 'Nhân viên-'.date('Y-m-d').'.xlsx');
    }
