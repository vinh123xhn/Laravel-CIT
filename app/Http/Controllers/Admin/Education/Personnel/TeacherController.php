...
class TeacherController extends Controller
{
    ...
    public function index() {
        $teachers = Personnel::whereIn('type_teacher', [1,2,3,4,5])->with('school', 'commune', 'district')->get();
        $districts = District::pluck('name', 'id');
        return view('admin.education.personnel.teacher.list')->with(compact('teachers', 'districts'));
    }

    public function filter(Request $request) {
        $districts = District::pluck('name', 'id');
        $teachers = Personnel::with('commune','district', 'school')->whereIn('type_teacher', [1,2,3,4,5]);
        $filter = [];
    ...
    public function getForm() {
        ...
        $districts = District::pluck('name', 'id');
        return view('admin.education.personnel.teacher.form')->with(compact('schools','districts'));
    }
    ...
    public function saveForm(Request $request) {
        ...
        if ($validator->fails()) {
            ...
            return redirect()->route('admin.personnel.teacher.list');
        }
    }
    ...
    public function editForm($id) {
        ...
        return view('admin.education.personnel.teacher.edit', compact('teacher', 'schools', 'districts', 'communes'));
    }
