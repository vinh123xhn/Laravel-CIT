...
class PersonnelController extends Controller
{
    ...
    public function indexManager() {
        $teachers = Personnel::with('school', 'commune', 'district')->get();
    ...
    public function getForm() {
        ...
        $districts = District::pluck('name', 'id');
        return view('admin.education.personnel.form')->with(compact('schools','districts'));
    }
    ...
    public function saveForm(Request $request) {
        ...
        if ($validator->fails()) {
            ...
            return redirect()->route('admin.personnel.list');
        }
    }
    ...
    public function editForm($id) {
        ...
        return view('admin.education.personnel.edit', compact('teacher', 'schools', 'districts', 'communes'));
    }
