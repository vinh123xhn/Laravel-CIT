...
class NurserySchoolController extends Controller
{
    ...
    public function editForm($id) {
        $districts = District::pluck('name', 'id');
        $school = NurserySchool::FindOrFail($id);
        $communes = Commune::where('district_id', '=', $school->district_id)->pluck('name', 'id');
        return view('admin.education.school.nursery.edit', compact('school', 'districts', 'communes'));
    }
    ...
    public function updateForm(Request $request, $id) {
        ...
        if ($validator->fails()) {
            ...
            NurserySchool::where('id', '=', $id)->update($updateRequest);
            return redirect()->route('admin.school.nursery.list');
        }
    }
    ...
    public function delete($id) {
        NurserySchool::FindOrFail($id)->delete();
