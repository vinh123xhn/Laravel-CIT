    ...
    public function __construct()
{
    ...
    $schools = PrimaryJuniorHighSchool::get();
    ...
    $districts = District::pluck('name', 'id');
    $school = PrimaryJuniorHighSchool::FindOrFail($id);
    $communes = Commune::where('district_id', '=', $school->district_id)->pluck('name', 'id');
    return view('admin.education.school.primary_junior_high.edit', compact('school', 'districts', 'communes'));
}
    ...
    if ($validator->fails()) {
        ...
        PrimaryJuniorHighSchool::where('id', '=', $id)->update($updateRequest);
        return redirect()->route('admin.school.primary_junior_high.list');
    }
}
    ...
    PrimaryJuniorHighSchool::FindOrFail($id)->delete();
