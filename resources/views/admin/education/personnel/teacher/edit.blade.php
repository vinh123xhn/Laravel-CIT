...
@section('content')
    <div class="col-md-8">
        ...
        <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form role="form" method="post" action="{{route('admin.personnel.teacher.form.update', $teacher->id)}}" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="day_and_year" placeholder="Nhập ngày vào làm việc" value="{{old('day_and_year') ? old('day_and_year') : $teacher->day_and_year}}">
                        @error('day_and_year')
                        <p class="danger">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="card-footer">
                    <a class="btn btn-primary" href="{{route('admin.personnel.teacher.list')}}">quay lại</a>
