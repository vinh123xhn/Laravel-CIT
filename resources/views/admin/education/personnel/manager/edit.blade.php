...
@section('content')
    <div class="col-md-8">
        ...
        <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form role="form" method="post" action="{{route('admin.personnel.manager.form.update', $manager->id)}}" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                ...
                <div class="card-footer">
                    <a class="btn btn-primary" href="{{route('admin.personnel.manager.list')}}">quay lại</a>
