...
@section('content')
    <div class="col-md-8">
        ...
        <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form role="form" method="post" action="{{route('admin.teacher.form.update', $teacher->id)}}">
                @csrf
                <div class="card-body">
                    <div class="form-group">
                        <label for="exampleInputEmail1">Họ và tên</label>
                        <input type="text" name="name" class="form-control" placeholder="Nhập tên cơ sở giáo dục" value="{{old('name') ? old('name') : $teacher->name}}">
                        @error('name')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="birthday" class="form-control" placeholder="Nhập tên cơ sở giáo dục" value="{{old('birthday') ? old('birthday') : $teacher->birthday}}">
                        @error('birthday')
                        <p class="danger">{{ $message }}</p>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="phone" placeholder="Nhập mã giới thiệu" value="{{old('phone') ? old('phone') : $teacher->phone}}">
                        @error('phone')
                        <p class="danger">{{ $message }}</p>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="email" placeholder="Nhập mã giới thiệu" value="{{old('email') ? old('email') : $teacher->email}}">
                        @error('email')
                        <p class="danger">{{ $message }}</p>
                        @enderror
                    </div>
