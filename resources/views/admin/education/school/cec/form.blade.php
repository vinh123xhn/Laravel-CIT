                ...
                <div class="card-body">
                    ...
                    <div class="col-md-6 float-left">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="total_of_xmc" placeholder="Nhập tổng số xóa mù chữ" value="{{old('total_of_xmc')}}">
                            @error('total_of_xmc')
                            <p class="danger">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6 float-left">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="total_of_gdttskbc" placeholder="Nhập tổng số lớp giáo dục tiếp tục sau khi biết chữ" value="{{old('total_of_gdttskbc')}}">
                    ...
                    <div class="col-md-6 float-left">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="total_of_9" placeholder="Nhập tổng số lớp 9" value="{{old('total_of_9')}}">
                            @error('total_of_9')
                            <p class="danger">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6 float-left">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="total_of_10" placeholder="Nhập tổng số lớp 10" value="{{old('total_of_10')}}">
                            @error('total_of_10')
                            <p class="danger">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6 float-left">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="total_of_11" placeholder="Nhập tổng số lớp 11" value="{{old('total_of_11')}}">
                            @error('total_of_11')
                            <p class="danger">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6 float-left">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="total_of_12" placeholder="Nhập tổng số lớp 12" value="{{old('total_of_12')}}">
                            @error('total_of_12')
                            <p class="danger">{{ $message }}</p>
                            @enderror
                        </div>
