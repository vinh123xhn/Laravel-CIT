...
@section('content')
    <div class="col-md-12">
        ...
        <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form role="form" method="post" action="{{route('admin.school.cec.form.update', $school->id)}}" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    ...
                    <div class="col-md-6 float-left">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="total_of_grade_xmc" placeholder="Nhập tổng số lớp xóa mù chữ" value="{{old('total_of_grade_xmc') ? old('total_of_grade_xmc') : $data->total_of_grade_xmc}}">
                    ...
                    <div class="col-md-6 float-left">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="total_of_grade_gdttskbc" placeholder="Nhập tổng số lớp giáo dục tiếp tục sau khi biết chữ" value="{{old('total_of_grade_gdttskbc') ? old('total_of_grade_gdttskbc') : $data->total_of_grade_gdttskbc}}">
                    ...
                    <div class="col-md-6 float-left">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="total_of_student_xmc" placeholder="Nhập tổng số học sinh XMC" value="{{old('total_of_student_xmc') ? old('total_of_student_xmc') : $data->total_of_student_xmc}}">
                    ...
                    <div class="col-md-6 float-left">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="total_of_student_gdttskbc" placeholder="Nhập tổng số học sinh GDTTSKBC" value="{{old('total_of_student_gdttskbc') ? old('total_of_student_gdttskbc') : $data->total_of_student_gdttskbc}}">
                    ...
                    <div class="col-md-6 float-left">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="total_of_student_work_8" placeholder="Nhập tổng số học sinh nghề 8" value="{{old('total_of_student_work_8') ? old('total_of_student_work_8') : $data->total_of_student_work_8}}">
                    ...
                    <div class="col-md-6 float-left">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="total_of_student_work_11" placeholder="Nhập tổng số học sinh nghề 11" value="{{old('total_of_student_work_11') ? old('total_of_student_work_11') : $data->total_of_student_work_11}}">
                    ...
                    <div class="col-md-6 float-left">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="total_of_student_it" placeholder="Nhập tổng số học viên cc tin học A,B,C" value="{{old('total_of_student_it') ? old('total_of_student_it') : $data->total_of_student_it}}">
                    ...
                    <div class="col-md-6 float-left">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="total_of_student_international" placeholder="Nhập tổng số học viên cc ngoại ngữ A,B,C" value="{{old('total_of_student_international') ? old('total_of_student_international') : $data->total_of_student_international}}">
                    ...
                    <div class="col-md-6 float-left">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="total_subject_room" placeholder="Nhập tổng số phòng học bộ môn" value="{{old('total_subject_room') ? old('total_subject_room') : $data->total_subject_room}}">
