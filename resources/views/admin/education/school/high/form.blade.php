    ...
    <div class="col-md-12">
        ...
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">Tạo mới trường thpt</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form role="form" method="post" action="{{route('admin.school.high.form.post')}}">
                @csrf
                <div class="card-body">
                ...
                <div class="card-footer">
                    <a class="btn btn-primary" href="{{route('admin.school.high.list')}}">quay lại</a>
