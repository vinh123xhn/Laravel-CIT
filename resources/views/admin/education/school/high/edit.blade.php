...
@section('content')
    <div class="col-md-12">
        ...
        <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form role="form" method="post" action="{{route('admin.school.high.form.update', $school->id)}}" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    ...
                    <div class="col-md-6 float-left">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="day_and_day_and_day_and_year" placeholder="Nhập ngày thành lập" value="{{old('day_and_day_and_day_and_year') ? old('day_and_day_and_day_and_year') : $school->day_and_day_and_day_and_year}}">
                            @error('day_and_day_and_day_and_year')
                            <p class="danger">{{ $message }}</p>
                            @enderror
                        </div>
                    </div>
