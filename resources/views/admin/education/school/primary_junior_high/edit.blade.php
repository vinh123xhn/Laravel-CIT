...
@section('content')
    <div class="col-md-12">
        ...
        <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form role="form" method="post" action="{{route('admin.school.primary_junior_high.form.update', $school->id)}}" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    ...
                    <div class="col-md-6 float-left">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="total_of_primary_teacher" placeholder="Nhập tổng số giáo viên tiểu học" value="{{old('total_of_primary_teacher') ? old('total_of_primary_teacher') : $data->total_of_primary_teacher}}">
                    ...
                    <div class="col-md-6 float-left">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="total_of_junior_high_teacher" placeholder="Nhập tổng số giáo viên thcs" value="{{old('total_of_junior_high_teacher') ? old('total_of_junior_high_teacher') : $data->total_of_junior_high_teacher}}">
