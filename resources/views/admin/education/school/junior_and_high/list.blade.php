        ...
        <table id="school" class="table table-bordered table-hover" style="width: 7000px">
            ...
            @foreach($schools as $item)
                <tr>
                    ...
                    <td>{{$item['junior_and_high']['total_of_6']}}</td>
                    <td>{{$item['junior_and_high']['total_of_7']}}</td>
                    <td>{{$item['junior_and_high']['total_of_8']}}</td>
                    <td>{{$item['junior_and_high']['total_of_9']}}</td>
                    <td>{{$item['junior_and_high']['total_of_10']}}</td>
                    <td>{{$item['junior_and_high']['total_of_11']}}</td>
                    <td>{{$item['junior_and_high']['total_of_12']}}</td>
                    <td></td>
                    <td></td>
                    <td></td>
                    <td></td>
